 ...
 * @author saudd
 */
public class valoracionesRes extends HttpServlet {
    ...
    public void init() throws ServletException {
        try {
            ...
            Logger.getLogger(valoracionesRes.class.getName()).log(Level.SEVERE, null, ex);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String comentarios = request.getParameter("comentariosRes");
        ...
        //catalogo.insertarValoracionRes(prompt,estrellas,comentarios);
